...
if __name__ == "__main__":
    ...
    arg_parser.add_argument('--config', type=str, required=False, default="config.yml")
    ...
    # build the vocabularies for source and target numerals: this should result in a vocabulary of
